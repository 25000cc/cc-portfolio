    ...
    <div className="text-center">
      <div className="w-[640px]	text-left inline-block max-w-full">
        <div className="flex flex-col sm:flex-row items-start">
          <img className="rounded-[200px] m-auto sm:m-0" src="https://images.microcms-assets.io/assets/f5e60180b6054e0eb4e7abe02497b919/475f5591636f44c8a9ff0b63eb2756d4/icon-2024-02-29.png" alt="icon" width="200" height="200"/>
